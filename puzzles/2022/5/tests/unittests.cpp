...
TEST_CASE(
    ...
    "[2022, 2022_5, part1, 2022_5_part1]")
{
...
TEST_CASE(
    "[2022_5] Use example input for Part 2",
    "[2022, 2022_5, part2, 2022_5_part2]")
{
    constexpr auto InputFile{"input_test.txt"};
...
TEST_CASE(
    "[2022_5] Use real input for Part 1", "[2022, 2022_5, part1, 2022_5_part1]")
{
...
TEST_CASE(
    "[2022_5] Use real input for Part 2", "[2022, 2022_5, part1, 2022_5_part2]")
{
    constexpr auto InputFile{"input.txt"};
