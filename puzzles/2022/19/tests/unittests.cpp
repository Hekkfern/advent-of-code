...
TEST_CASE(
    "[2022_19] Use example input for Part 1",
    "[2022, 2022_19, part1, 2022_19_part1]")
{
    constexpr auto InputFile{"input_test.txt"};

    std::string mySolution = aoc_2022_19::solvePart1(InputFile);
...
TEST_CASE(
    "[2022_19] Use example input for Part 2",
    "[2022, 2022_19, part2, 2022_19_part2]")
{
    constexpr auto InputFile{"input_test.txt"};

    std::string mySolution = aoc_2022_19::solvePart2(InputFile);
    std::string expectedSolution
...
TEST_CASE(
    "[2022_19] Use real input for Part 1",
    "[2022, 2022_19, part1, 2022_19_part1]")
{
...
TEST_CASE(
    "[2022_19] Use real input for Part 2",
    "[2022, 2022_19, part1, 2022_19_part2]")
{
    constexpr auto InputFile{"input.txt"};
