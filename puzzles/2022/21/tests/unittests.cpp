...
TEST_CASE(
    "[2022_21] Use example input for Part 1",
    "[2022, 2022_21, part1, 2022_21_part1]")
{
    constexpr auto InputFile{"input_test.txt"};

    std::string mySolution = aoc_2022_21::solvePart1(InputFile);
...
TEST_CASE(
    "[2022_21] Use example input for Part 2",
    "[2022, 2022_21, part2, 2022_21_part2]")
{
    constexpr auto InputFile{"input_test.txt"};

    std::string mySolution = aoc_2022_21::solvePart2(InputFile);
    std::string expectedSolution
...
TEST_CASE(
    "[2022_21] Use real input for Part 1",
    "[2022, 2022_21, part1, 2022_21_part1]")
{
...
TEST_CASE(
    "[2022_21] Use real input for Part 2",
    "[2022, 2022_21, part1, 2022_21_part2]")
{
    constexpr auto InputFile{"input.txt"};
