...
TEST_CASE(
    "[2023_3] Use example input for Part 1",
    "[2023, 2023_3, part1, 2023_3_part1]")
{
    constexpr auto InputFile{"input1_test.txt"};

    std::string const mySolution = aoc_2023_3::solvePart1(InputFile);
...
TEST_CASE(
    "[2023_3] Use example input for Part 2",
    "[2023, 2023_3, part2, 2023_3_part2]")
{
    constexpr auto InputFile{"input2_test.txt"};

    std::string const mySolution = aoc_2023_3::solvePart2(InputFile);
    std::string const expectedSolution
...
TEST_CASE(
    "[2023_3] Use real input for Part 1", "[2023, 2023_3, part1, 2023_3_part1]")
{
...
TEST_CASE(
    "[2023_3] Use real input for Part 2", "[2023, 2023_3, part1, 2023_3_part2]")
{
    constexpr auto InputFile{"input.txt"};
