    ...
    "[2023][2023_21][part1][2023_21_part1]")
{
    ...
    std::string const mySolution = aoc_2023_21::solvePart1(InputFile);
...
TEST_CASE(
    "[2023_21] Use example input for Part 2",
    "[2023][2023_21][part2][2023_21_part2]")
{
    constexpr auto InputFile{ "input2_test.txt" };

    std::string const mySolution = aoc_2023_21::solvePart2(InputFile);
    std::string const expectedSolution = utils::file::readFirstLine(
                                       "solution2_test.txt")
                                       .value();
