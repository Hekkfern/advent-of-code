...
TEST_CASE(
    "[2023_7] Use example input for Part 1",
    "[2023][2023_7][part1][2023_7_part1]")
{
    constexpr auto InputFile{"input1_test.txt"};

    std::string const mySolution = aoc_2023_7::solvePart1(InputFile);
...
TEST_CASE(
    "[2023_7] Use example input for Part 2",
    "[2023][2023_7][part2][2023_7_part2]")
{
    constexpr auto InputFile{"input2_test.txt"};

    std::string const mySolution = aoc_2023_7::solvePart2(InputFile);
    std::string const expectedSolution
...
TEST_CASE(
    "[2023_7] Use real input for Part 1", "[2023][2023_7][part1][2023_7_part1]")
{
...
TEST_CASE(
    "[2023_7] Use real input for Part 2", "[2023][2023_7][part1][2023_7_part2]")
{
    constexpr auto InputFile{"input.txt"};
