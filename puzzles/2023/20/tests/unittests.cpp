...
TEST_CASE(
    "[2023_20] Use example input A for Part 1",
    "[2023][2023_20][part1][2023_20_part1]")
{
    constexpr auto InputFile{"input1a_test.txt"};

    std::string const mySolution = aoc_2023_20::solvePart1(InputFile);
...
TEST_CASE(
    "[2023_20] Use example input B for Part 1",
    "[2023][2023_20][part1][2023_20_part1]")
{
...
TEST_CASE(
    "[2023_20] Use real input for Part 2",
    "[2023][2023_20][part1][2023_20_part2]")
{
    constexpr auto InputFile{"input.txt"};
