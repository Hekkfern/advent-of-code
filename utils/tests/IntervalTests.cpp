...
{
    const Interval<int32_t> interval1{2, 3};
...
TEST_CASE(
    ...
    "[Interval, Interval_getters]")
{
    const Interval<int32_t> interval2{-3, 1};
...
{
    CHECK_THROWS(Interval<int32_t>{2, -3});
}
...
{
    const Interval<int32_t> interval1{2, 4};
    const Interval<int32_t> interval2{-3, 1};
    const std::optional<Interval<int32_t>> result1{interval1.join(interval2)};
    CHECK(result1);
    CHECK(result1->get() == std::make_pair(-3, 4));
    const Interval<int32_t> interval3{3, 6};
    const std::optional<Interval<int32_t>> result2{interval1.join(interval3)};
    CHECK(result2);
...
{
    const Interval<int32_t> interval1{2, 4};
    const Interval<int32_t> interval2{-3, 3};
    const std::optional<Interval<int32_t>> result1{interval1.join(interval2)};
    CHECK(result1);
    CHECK(result1->get() == std::make_pair(-3, 4));
}
...
{
    const Interval<int32_t> interval1{2, 4};
    const Interval<int32_t> interval2{2, 2};
    const std::optional<Interval<int32_t>> result1{interval1.join(interval2)};
    CHECK(result1);
    CHECK(result1->get() == std::make_pair(2, 4));
    const Interval<int32_t> interval3{1, 1};
    const std::optional<Interval<int32_t>> result2{interval1.join(interval3)};
    CHECK(result2);
    CHECK(result2->get() == std::make_pair(1, 4));
    const Interval<int32_t> interval4{5, 5};
    const std::optional<Interval<int32_t>> result3{interval1.join(interval4)};
    CHECK(result3);
    CHECK(result3->get() == std::make_pair(2, 5));
    const Interval<int32_t> interval5{7, 7};
    const std::optional<Interval<int32_t>> result4{interval1.join(interval5)};
    CHECK_FALSE(result4);
}
    ...
    "[Interval, Interval_intersect]")
{
    const Interval<int32_t> interval1{2, 3};
    const Interval<int32_t> interval2{-3, 1};
    const Interval<int32_t> interval3{-3, 4};
    const Interval<int32_t> interval4{-5, -1};
    ...
    "[Interval, Interval_subsumes]")
{
    const Interval<int32_t> interval1{2, 3};
    const Interval<int32_t> interval2{-3, 1};
    const Interval<int32_t> interval3{-3, 3};
...
{
    const Interval<int32_t> interval1{2, 7};
...
{
    const Interval<int32_t> interval1{2, 7};
    const Interval<int32_t> interval2{-1, 1};
    ...
    const Interval<int32_t> interval4{8, 9};
