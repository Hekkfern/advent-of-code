...
TEST_CASE(
    ...
    "[Direction2D, Direction2D_invert]")
{
...
TEST_CASE(
    ...
    "[Direction2D, Direction2D_turnLeft]")
{
    std::vector<std::pair<Direction2D, Direction2D>> const testCases{
    ...
    for (auto const& [direction, expectedLeftTurn] : testCases) {
        CHECK(direction.turnLeft() == expectedLeftTurn);
    }
}

TEST_CASE(
    "[Direction2D - turnRight] turnRight returns the correct value",
    "[Direction2D, Direction2D_turnRight]")
{
    std::vector<std::pair<Direction2D, Direction2D>> const testCases{
    ...
    for (auto const& [direction, expectedRightTurn] : testCases) {
        CHECK(direction.turnRight() == expectedRightTurn);
    }
}