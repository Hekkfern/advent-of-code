...
RUN dnf install -y curl wget tar zip unzip sudo \
  && dnf install -y make ninja-build gcc-c++ cmake git python3 python3-pip ccache clang-tools-extra gdb cppcheck \
