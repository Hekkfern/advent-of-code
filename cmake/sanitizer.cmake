  ...
  elseif("${SANITIZER}" STREQUAL "address")
    ...
    if(${CMAKE_BUILD_TYPE} STREQUAL "Debug")
      set(ASAN_LIBRARY_NAME
          "clang_rt.asan_dbg_dynamic-${ASAN_ARCHITECTURE}.dll")
    else()
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy ${ASAN_LIBRARY_SOURCE}
              ${CMAKE_BINARY_DIR})
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy ${LLVM_SYMBOLIZER_SOURCE}
              ${CMAKE_BINARY_DIR})

    add_custom_target(CopyAsanBinaries ALL DEPENDS ${ASAN_LIBRARY_NAME}
                                                   ${LLVM_SYMBOLIZER_NAME})
